...
matrices_folder = "./instances/rectangular_dense_test"
m_values = [60 + (20 * i) for i in 0:27]

results_folder = "results/problem_$(problem)_test"

solutions_folder = "./solutions/problem_$(problem)_test"
